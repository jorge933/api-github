...
export function AddReposInDOM(Repos, $repos_cont) {
    Repos.forEach(repo => {
        const { description, forks, language, license, name, stargazers_count, updated_at, html_url:url } = repo;
        ...
        if (forks > 0) {
            ...
            <span class="total">${StylizeNumbers(forks)}</span>
            </div>`
        }
        ...
        switch (lang2class) {
            case 'c++': lang2class = 'c-more'; break;
            case 'c#': lang2class = 'c-sharp'; break;
        }
        ...
        $repos_cont.innerHTML += `<div class="repo">
                ...
                <div class="bottom">
                    <div class="lang">
                        ${language ? `<div class="${lang2class}"></div> <span>${language}</span>` : ''}
                    </div>
                    ...
                    <div class="stars">
                        ...
                        <span class="total">${StylizeNumbers(stargazers_count)}</span>
                    </div>
